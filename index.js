...
console.log(color('  🧞 Jimbru-v4.2 2022🧞','mediumseagreen'))
    ...
    console.log(color('🦋', 'cyan'), color('ℹ️ Connecting to WhatsApp...Please wait~', 'magenta'))
    ...
    const JimbruOffical = JimbruOfficalConnect({
        ...
        browser: ['Jimbru-v4.1','Safari','1.0.0'],
...
JimbruOffical.sendMessage(anu.id, buttonMessage, {quoted:unicorndoc})
                    ...
                    const jimbrumembers = metadata.participants.length
